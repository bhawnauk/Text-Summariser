...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "spacy/matcher",
            "/private/var/folders/5k/d57mf6rd6l5cqynd0snm4yx40000gn/T/pip-build-env-wacejvxu/overlay/lib/python3.9/site-packages/numpy/_core/include",
...
static int __Pyx_modinit_type_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  #endif
  __Pyx_ImportType_CheckSize_Warn_3_2_8); if (!__pyx_mstate->__pyx_ptype_7cpython_4type_type) __PYX_ERR(1, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
